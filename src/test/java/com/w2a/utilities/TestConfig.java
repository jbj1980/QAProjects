...
public class TestConfig{
	...
	public static String from = "gmborgjoseph@gmail.com";
	public static String password = "GmSyzBb5";
	public static String[] to ={"borgjosep@gmail.com","borgjoseph@icloud.com"};
	...
	public static String gittest = "localhost:3306/acs";
